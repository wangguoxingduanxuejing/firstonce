...
const menuDao = {
  ...
  addMenuDao: function(fn,params) {
    // console.log(params);
    logger.info({ methed: "addMenuDao", path: __filename });
  ...
  updateMenuDao: function(fn,params) {
    ...
    // console.log(params);
    logger.info({ methed: "updateMenuDao", path: __filename });
  ...
  deleteMenuDao: function(fn,params) {
    // console.log(params);
    logger.info({ methed: "deleteMenuDao", path: __filename });
  ...
  getElementsByMenuidDao:function(fn,params) {
    logger.info({ methed: "getElementsByMenuidDao", path: __filename });
   ...
   //根据菜单id获取按钮 不分页
  getElementByIdDao:function(fn,params) {
    logger.info({ methed: "getElementByIdDao", path: __filename });
    let sql = "SELECT * from base_element WHERE menu_id=?";
    executeSql(function(connection) {
      connection.query(sql,params, fn);
      connection.release();
    });
  ...
  addElementDao: function(fn,params) {
    ...
    // console.log(params);
    logger.info({ methed: "addElementDao", path: __filename });
  ...
  updateElementDao: function(fn,params) {
    // console.log(params);
    logger.info({ methed: "updateElementDao", path: __filename });
  ...
  deleteElementDao: function(fn,params) {
    // console.log(params);
    logger.info({ methed: "deleteElementDao", path: __filename });
